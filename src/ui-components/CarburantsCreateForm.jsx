...
import { createCarburants } from "../graphql/mutations";
export default function CarburantsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createCarburants.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CarburantsCreateForm")}
      {...rest}
    >
      <TextField
        label="Level"
